...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/orderlist.vue?vue&type=template&id=409322dc&
var render = function render() {
  ...
  })]), _vm._ssrNode(" <h6>Order List </h6>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-3 desktop_view\">", "</div>", [_c('LeftsidebarDesktop')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-9\">", "</div>", [_vm._ssrNode("<h4>Orders </h4> "), _vm.loading ? _vm._ssrNode("<span>", "</span>", [_c('Loader')], 1) : _vm._e(), _vm._ssrNode(" <div class=\"order_list\"><ul><li><div><h6>Order ID</h6></div> <div><h6>Date</h6></div> <div><h6>Ammount</h6></div> <div><h6>Status</h6></div> <div><h6>Action</h6></div></li> " + _vm._ssrList(_vm.orders, function (order) {
    return "<li><div><p>" + _vm._ssrEscape(_vm._s(order.orderId)) + "</p></div> <div><p>" + _vm._ssrEscape(_vm._s(order.placeOn)) + "</p></div> <div><p>" + _vm._ssrEscape(_vm._s(order.total) + " TK.") + "</p></div> <div><p>" + _vm._ssrEscape(_vm._s(order.name)) + "</p></div> <div><a href=\"#\" class=\"btn-submit\"><i class=\"fa-solid fa-file-invoice\"></i></a></div></li>";
  }) + "</ul></div>")], 2)], 2)], 2), _vm._ssrNode(" "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/orderlist.vue?vue&type=template&id=409322dc&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/orderlist.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/user/orderlist.vue?vue&type=script&lang=js&
 /* harmony default export */ var user_orderlistvue_type_script_lang_js_ = (orderlistvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/user/orderlist.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  user_orderlistvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
