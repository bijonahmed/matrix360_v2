...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/notification.vue?vue&type=template&id=6ac1d49c&
var render = function render() {
  ...
  })]), _vm._ssrNode(" <h6>Notification </h6>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-3 desktop_view\">", "</div>", [_c('LeftsidebarDesktop')], 1), _vm._ssrNode(" <div class=\"col-xl-9\"><div class=\"profile_right\"><h1 class=\"desktop_view\">Notification &amp; Performance </h1> <div class=\"alert p-0\"><div class=\"row\"><div class=\"col-md-6\"><div class=\"total_amt\"><ul><h6>Promotional Notifications</h6> <p>Includes campaign launch, offers and newsletter.</p> <li><h1>Email</h1> <div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\"> <div class=\"checkbox__checkmark\"></div></label></div></li> <li><h1>SMS</h1> <div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\"> <div class=\"checkbox__checkmark\"></div></label></div></li> <li><h1>WhatsApp</h1> <div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\"> <div class=\"checkbox__checkmark\"></div></label></div></li> <li><h1>Push Notifications</h1> <div class=\"checkboxes__item\"><label class=\"checkbox style-e\"><input type=\"checkbox\"> <div class=\"checkbox__checkmark\"></div></label></div></li></ul></div></div></div></div></div></div>")], 2)], 2), _vm._ssrNode(" "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/notification.vue?vue&type=template&id=6ac1d49c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/notification.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/user/notification.vue?vue&type=script&lang=js&
...
// CONCATENATED MODULE: ./pages/user/notification.vue
