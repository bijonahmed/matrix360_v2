...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/settings.vue?vue&type=template&id=eb71596e&
var render = function render() {
  ...
  })]), _vm._ssrNode(" <h6>Payment </h6>")], 2)])]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\">", "</div>", [_vm._ssrNode("<div class=\"col-xl-3 desktop_view\">", "</div>", [_c('LeftsidebarDesktop')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"col-xl-9\">", "</div>", [_vm._ssrNode("<div class=\"profile_right\">", "</div>", [_vm.loading ? _vm._ssrNode("<span>", "</span>", [_c('Loader')], 1) : _vm._e(), _vm._ssrNode(" <h1 class=\"desktop_view\">Chagne Password </h1> <form id=\"formrest\" enctype=\"multipart/form-data\" class=\"forms-sample\"><div class=\"row\"><div class=\"col-md-6\"><div class=\"input-container\"><input placeholder=\"New Password \" type=\"password\"" + _vm._ssrAttr("value", _vm.passdata.password) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">New Password </label> " + (_vm.errors.password ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input-container\"><input placeholder=\"Confirm Password \" type=\"password\"" + _vm._ssrAttr("value", _vm.passdata.password_confirmation) + " class=\"input-field\"> <label for=\"input-field\" class=\"input-label\">Confirm Password </label> " + (_vm.errors.password_confirmation ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password_confirmation[0])) + "</span>" : "<!---->") + " <span class=\"input-highlight\"></span></div></div> <div class=\"col-md-6\"><div class=\"input-container\"><input value=\"Update Password\" type=\"submit\" class=\"btn_submit\"></div></div></div></form>")], 2)])], 2)], 2), _vm._ssrNode(" "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/user/settings.vue?vue&type=template&id=eb71596e&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/user/settings.vue?vue&type=script&lang=js&
