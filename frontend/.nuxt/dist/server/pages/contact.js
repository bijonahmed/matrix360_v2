...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/contact.vue?vue&type=template&id=0215a316&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm._v("home")])], 1), _vm._ssrNode(" <li>contact us</li>")], 2)])])])])]), _vm._ssrNode(" <div class=\"contact_page_bg\"><div class=\"contact_map\"><div class=\"map-area\"><div class=\"embed-map-responsive\"><div class=\"embed-map-container\"><div class=\"embed-map-responsive\"><div class=\"embed-map-container\"><iframe frameborder=\"0\" scrolling=\"no\" marginheight=\"0\" marginwidth=\"0\" src=\"https://maps.google.com/maps?width=800&height=400&hl=en&q=6065%20Hillcroft%20Street%2C%20Suite%20%23%20511%2C%20Houston%2C%20TX%2077081.&t=&z=16&ie=UTF8&iwloc=B&output=embed\" class=\"embed-map-frame\"></iframe></div></div></div></div></div></div> <div class=\"container\"><div class=\"contact_area\"><div class=\"row\"><div class=\"col-lg-6 col-md-12\"><div class=\"contact_message content\"><h3>contact us</h3> <ul><li><i class=\"fa fa-fax\"></i> Address : 6065 Hillcroft Street, Suite # 511, Houston,\n                                    TX 77081.</li> <li><i class=\"fa fa-phone\"></i> <a href=\"#\">support@matrix360sourcing.com</a></li> <li class=\"d-none\"><i class=\"fa fa-envelope-o\"></i><a href=\"https://api.whatsapp.com/send?phone=14694221192\" target=\"_blank\">+14694221192</a></li></ul></div></div> <div class=\"col-lg-6 col-md-12\"><div class=\"contact_message form\"><h3>Tell us your project</h3> <form id=\"otp-screen\"><p><label>Your Name (required)</label> <input name=\"name\" placeholder=\"Name *\" type=\"text\"" + _vm._ssrAttr("value", _vm.sendmailData.name) + "> " + (_vm.errors.name ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.name[0])) + "</span>" : "<!---->") + "</p> <p><label>Your Email (required)</label> <input name=\"email\" placeholder=\"Email *\" type=\"email\"" + _vm._ssrAttr("value", _vm.sendmailData.email) + "> " + (_vm.errors.email ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.email[0])) + "</span>" : "<!---->") + "</p> <p><label>Subject (required)</label> <input name=\"subject\" placeholder=\"Subject *\" type=\"text\"" + _vm._ssrAttr("value", _vm.sendmailData.subject) + "> " + (_vm.errors.subject ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.subject[0])) + "</span>" : "<!---->") + "</p> <div class=\"contact_textarea\"><label>Your Message (required)</label> <textarea placeholder=\"Message *\" name=\"message\" class=\"form-control2\">" + _vm._ssrEscape(_vm._s(_vm.sendmailData.messages)) + "</textarea> " + (_vm.errors.messages ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.messages[0])) + "</span>" : "<!---->") + "</div> <button type=\"submit\">Send</button></form></div></div></div></div></div></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/contact.vue?vue&type=template&id=0215a316&
...
/* harmony default export */ var contactvue_type_script_lang_js_ = ({
  ...
  methods: {
    sendmail() {
      ...
      this.$axios.post('/unauthenticate/sendmail', formData, {
        headers
      }).then(response => {
        // this.loading = false;
