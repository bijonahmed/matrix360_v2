...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/register.vue?vue&type=template&id=79eaced4&
var render = function render() {
  ...
  }, [_vm._v("home")])], 1), _vm._ssrNode(" <li>register</li>")], 2)])])])])]), _vm._ssrNode(" <div class=\"login_page_bg\"><div class=\"container\"><div class=\"customer_login\"><div class=\"row\"><div class=\"col-lg-12 col-md-12\"><div class=\"account_form\"><h2>Register</h2> <form id=\"formrest\"><p><label>Name <span>*</span></label> <input type=\"text\" placeholder=\"Enter your name\"" + _vm._ssrAttr("value", _vm.insertdata.name) + "> " + (_vm.errors.name ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.name[0])) + "</span>" : "<!---->") + "</p> <p><label>Email <span>*</span></label> <input type=\"email\" placeholder=\"Enter your email\"" + _vm._ssrAttr("value", _vm.insertdata.email) + "> " + (_vm.errors.email ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.email[0])) + "</span>" : "<!---->") + "</p> <p><label>Phone Number <span>*</span></label> <input type=\"text\" placeholder=\"01700000000\"" + _vm._ssrAttr("value", _vm.insertdata.phone_number) + "> " + (_vm.errors.phone_number ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.phone_number[0])) + "</span>" : "<!---->") + "</p> <p><label>Password <span>*</span></label> " + ((_vm.showRegPassword ? 'text' : 'password') === 'checkbox' ? "<input placeholder=\"Password\" type=\"checkbox\"" + _vm._ssrAttr("checked", Array.isArray(_vm.insertdata.password) ? _vm._i(_vm.insertdata.password, null) > -1 : _vm.insertdata.password) + ">" : (_vm.showRegPassword ? 'text' : 'password') === 'radio' ? "<input placeholder=\"Password\" type=\"radio\"" + _vm._ssrAttr("checked", _vm._q(_vm.insertdata.password, null)) + ">" : "<input placeholder=\"Password\"" + _vm._ssrAttr("type", _vm.showRegPassword ? 'text' : 'password') + _vm._ssrAttr("value", _vm.insertdata.password) + ">") + " " + (_vm.errors.password ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password[0])) + "</span>" : "<!---->") + "</p> <p><label>Confirm Password <span>*</span></label> " + ((_vm.showRegConPassword ? 'text' : 'password') === 'checkbox' ? "<input placeholder=\"Confirm Password\" type=\"checkbox\"" + _vm._ssrAttr("checked", Array.isArray(_vm.insertdata.password_confirmation) ? _vm._i(_vm.insertdata.password_confirmation, null) > -1 : _vm.insertdata.password_confirmation) + ">" : (_vm.showRegConPassword ? 'text' : 'password') === 'radio' ? "<input placeholder=\"Confirm Password\" type=\"radio\"" + _vm._ssrAttr("checked", _vm._q(_vm.insertdata.password_confirmation, null)) + ">" : "<input placeholder=\"Confirm Password\"" + _vm._ssrAttr("type", _vm.showRegConPassword ? 'text' : 'password') + _vm._ssrAttr("value", _vm.insertdata.password_confirmation) + ">") + " " + (_vm.errors.password_confirmation ? "<span class=\"text-danger\">" + _vm._ssrEscape(_vm._s(_vm.errors.password_confirmation[0])) + "</span>" : "<!---->") + "</p> <div class=\"login_submit\"><button type=\"submit\">Register</button></div></form></div></div></div></div></div></div> "), _c('Footer')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/register.vue?vue&type=template&id=79eaced4&
