...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/forget-password.vue?vue&type=template&id=77bbd264&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_c('Navbar'), _vm._ssrNode(" <section class=\"otp_sec\"><div class=\"container\"><div class=\"row\"><div bis_skin_checked=\"1\" class=\"col-md-6 my-3 mx-auto d-flex\"><div bis_skin_checked=\"1\" class=\"container my-auto py-5\" style=\"background-color: #373737;border-radius: 20px;\"><div bis_skin_checked=\"1\" class=\"row g-0\"><div bis_skin_checked=\"1\" class=\"col-11 col-sm-10 col-lg-9 col-xl-8 mx-auto\">" + (_vm.status === 0 ? "<h3" + _vm._ssrClass("fw-600 mb-4 text-center", {
    'text-danger': _vm.status === 0
  }) + ">" + _vm._ssrEscape(_vm._s(_vm.verifymsg)) + "</h3>" : "<!---->") + " <h3 class=\"fw-600 mb-4\">Forget Password</h3> <form id=\"otp-screen\" class=\"forms-sample\"><div bis_skin_checked=\"1\" class=\"row g-3\"><div bis_skin_checked=\"1\" class=\"col-12\"><input type=\"text\" placeholder=\"01xxxxxxx\" autocomplete=\"off\"" + _vm._ssrAttr("value", _vm.insertdata.number) + " class=\"form-control text-center text-6 py-2\"> " + (_vm.errors.number ? "<span class=\"text-danger\" style=\"font-size:10px ;\">" + _vm._ssrEscape(_vm._s(_vm.errors.number[0])) + "</span>" : "<!---->") + "</div></div> <div bis_skin_checked=\"1\" class=\"d-grid my-4\"><button type=\"submit\" class=\"btn\" style=\"background-color: #b5f927;\">Submit</button></div></form></div></div></div></div></div></div></section> "), _c('Footer'), _vm._ssrNode(" "), _c('MobileMenu')], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/forget-password.vue?vue&type=template&id=77bbd264&
...
/* harmony default export */ var forget_passwordvue_type_script_lang_js_ = ({
  ...
  methods: {
    saveData() {
      ...
      this.$axios.post('/unauthenticate/forgetPassword', formData, {
        headers
      }).then(response => {
