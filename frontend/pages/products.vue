                        ...
                        <div class="product-item">
                            <div class="product-item-images">
                                <nuxt-link :to="`/product-details/${item.slug}`" class="product-item-image-inner">
                                    <img :src="item.thumnail" alt="product image" loading="lazy" class="custom-border" style="height:400px; width: 100%;">
                                    <img :src="item.thumnail" alt="product image" loading="lazy" class="custom-border">
                                </nuxt-link>
                            ...
                            <!-- <div class="product-item-content">
                                <nuxt-link :to="`/product-details/${item.slug}`" style="color:black; font-size: 15px;">{{ item.name }} </nuxt-link>
                                <center style="font-size: 15px; font-weight: bold;"><span class="currency-symbol">$</span><strong>{{ item.price }}</strong></center>
                            </div> -->
