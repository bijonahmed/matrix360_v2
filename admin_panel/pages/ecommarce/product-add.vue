                                            ...
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="image" role="tabpanel">
                                                    ...
                                                    <div class="row mb-3 d-none">
                                                        <label for="input-meta-description-1" class="col-sm-2 col-form-label">Select Size</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <h3 class="d-none"><strong>Addtional Product</strong></h3>
                                                    <div class="row mb-3 d-none">
...
export default {
    ...
    methods: {
        //     logSelectedData() {
        //   const selectedData = this.attribueData.filter(data => data.isSelected);
        ...
        async allsizes() {
            try {
                const response = await this.$axios.get(`/product/allsizes`);
