    ...
    <div>
                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-pills nav-pills-success" role="tablist">
                                    <li class="nav-item " role="presentation">
                                        <a class="nav-link active" data-bs-toggle="pill" href="#warning-pills-profile"
                                            role="tab" aria-selected="false">
                                            <div class="d-flex align-items-center">
                                                <div class="tab-icon"><i
                                                        class='fadeIn animated bx bx-add-to-queue font-18 me-1'></i>
                                                </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <form @submit.prevent="saveAttributeData()" id="formrest"
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select v-model="insertAttributedata.category_id"
                                                                        class="form-select category_id"
                                                                        @change="updateInputBox">
                                                            ...
                                                            <div class="row mb-3 d-none">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input class="form-control form-control-sm"
                                                                        ...
                                                                        v-model="insertAttributedata.name">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <textarea class="form-control form-control-sm"
                                                                        v-model="insertAttributedata.arr_value"
                                                                        placeholder="Must use comma , to separate different options."></textarea>
                                                                    <!-- <input class="form-control form-control-sm" type="text" placeholder="Name" v-model="insertAttributedata.name"> -->
                                                                    <span class="text-danger" v-if="errors.arr_value">{{
                                        errors.arr_value[0] }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                                <label for="input-meta-description-1"
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-select form-select-sm"
                                                                        ...
                                                                        v-model="insertAttributedata.status">
                                                        ...
                                                        <div class="scrollable-div-attribute">
                                                            <div class="table-responsive">
                                                                <table class="table table-hover table-sm">
                                                                    ...
                                                                    <tbody>
                                                                        <tr v-for="item in attributeslist"
                                                                            :key="item.id">
                                                                            <td>{{ item.name }}</td>
                                                                            <td>
                                                                                <span v-if="item.status == 1"
                                                                                    class="badge bg-primary text-white">Active</span>
                                                                                <span v-else
                                                ...
                                                <div class="col-md-3">
                                                    <div class="input-group mb-3">
                                                        <select class="form-select form-select-solid status"
                                                            v-model="searchQuery.status" @change="handleSearch">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="input-group mb-3">
                                                        <button class="btn btn-primary w-100" type="button"
                                                            @click="fetchAttributeValList">Search</button>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <tr v-for="item in paginatedData" :key="item.id">
                                                            ...
                                                            <td>
                                                                <center>
                                                                    ...
                                                                    <span @click="editAttrival(item.id)"><i
        ...
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <form @submit.prevent="saveAttributeData()" id="formrest" class="forms-sample"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label for="input-meta-description-1" class="col-sm-3 col-form-label">Category</label>
                                <div class="col-sm-9">
                                    <select v-model="insertAttributedata.category_id" class="form-select category_id"
                                        @change="updateInputBox">
                                        <option value="" selected>Select</option>
                                        <option v-for='data in category' :value='data.id'>{{ data.name }}</option>
                                    </select>
                                    <span class="text-danger" v-if="errors.category_id">{{ errors.category_id[0]
                                        }}</span>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="attrValModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <form @submit.prevent="saveAttributeVal()" id="formrest" class="forms-sample"
                    enctype="multipart/form-data">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control form-control-sm" type="text" placeholder="Name"
                                        v-model="insertAttributeVal.name">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select form-select-sm" aria-label=".form-select-sm example"
                                        v-model="insertAttributeVal.status">
                                        <option selected value="1">Active</option>
                                        <option value="0">Inactive</option>
                                    </select>
                                </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                @click="closemodalVal">Close</button>
                            <button type="submit" class="btn btn-primary">Update</button>
                        </div>
                    </div>
                </form>
...
export default {
    ...
    methods: {
        updateInputBox() {
            ...
            const selectedData = this.category.find(item => item.id === parseInt(this.insertAttributedata.category_id));
            const name = selectedData ? selectedData.name : '';
            this.insertAttributedata.name = selectedData ? selectedData.name : '';
        },
        closemodalVal() {
        ...
        attribute(id) {
            ...
            this.$axios.get(`/category/attributeRow/${id}`).then(response => {
                ...
                this.insertAttributedata.category_id = response.data.data.category_id;
            });
        },
        saveAttributeVal() {
        ...
        saveAttributeData() {
            ...
            formData.append('category_id', this.insertAttributedata.category_id);
